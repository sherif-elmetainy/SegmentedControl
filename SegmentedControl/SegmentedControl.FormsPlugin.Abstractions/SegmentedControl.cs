...
namespace SegmentedControl.FormsPlugin.Abstractions
{
    ...
    public class SegmentedControl : View, IViewContainer<SegmentedControlOption>
	{
		...
		public static readonly BindableProperty SelectedSegmentProperty = BindableProperty.Create("SelectedSegment", typeof(int), typeof(SegmentedControl), 0, BindingMode.TwoWay);
